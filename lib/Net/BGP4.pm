...
Net::BGP4 - Border Gateway Protocol version 4 speaker/listener library
...
This module is an implementation of the BGP4 inter-domain routing protocol.
It encapsulates all of the functionality needed to establish and maintain a
BGP4 peering session and exchange routing update information with the peer.
It aims to provide a simple API to the BGP4 protocol for the purposes of
...
of the BGP4 protocol. It supports multiple peering sessions and each peer
corresponds to one instance of a B<Net::BGP4::Peer> object. The details of
maintaining each peering session are handled and coordinated by an instance
of a B<Net::BGP4::Process> object. BGP UPDATE messages and the routing
information they represent are encapsulated by B<Net::BGP4::Update> objects.
Whenever protocol errors occur and a BGP NOTIFICATION is sent or received,
programs can determine the details of the error via B<Net::BGP4::Notification>
objects.
...
with the object - it might send a Net::BGP4::Update object to other peers
...
whenever a connection is received from a peer, the B<Net::BGP4::Peer> object
...
that B<Net::BGP4::Peer> objects be instantiated with the B<Listen> parameter
...
sessions. This problem will be addressed in a future revision of B<Net::BGP4>.
...
RFC 1771, and the perldocs for Net::BGP4::Process, Net::BGP4::Peer, Net::BGP4::Update,
and Net::BGP4::Notification
