...
## BGP4 Protocol Error Code and Subcode Enumerations ##
...
This module encapsulates the data contained in a BGP4 NOTIFICATION message.
...
user programs will need to instantiate B<Net::BGP4::Notification> objects
directly. However, when an error occurs and a NOTIFICATION message is sent
or received by a BGP peering session established with the B<Net::BGP4>
module, a reference to a B<Net::BGP4::Notification> object will be passed
...
I<new()> - create a new Net::BGP4::Notification object
...
This is the constructor for Net::BGP4::Notification objects. It returns a
...
B<Net::BGP4>, B<Net::BGP4::Process>, B<Net::BGP4::Peer>,
B<Net::BGP4::Update>
...
## End Package Net::BGP4::Notification ##
